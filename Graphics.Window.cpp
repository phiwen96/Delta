...
export struct window {
	...
	window (std::vector <window> * windows, VkInstance instance, PhysicalDevice const & physical_device) noexcept : window {windows, instance, physical_device, 640, 480, ""} {
	...
	window (std::vector <window> * windows, VkInstance instance, PhysicalDevice physical_device, int width, int height, char const* title) noexcept : windows {windows}, handle {glfwCreateWindow (width, height, title, nullptr, nullptr)}, is_open {true} {
