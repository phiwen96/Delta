...
struct element_traits_t <T>
{
	using type = typename iterator_traits_t <T>::element_type;//typename element_traits_t <typename function_traits_t <decltype (T::begin)>::return_type>>::element_type;
};
