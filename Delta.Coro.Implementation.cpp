...
// 			return coro {coroutine_handle <promise_type>::from_promise (*this), "get_return_object ()"};
// 		}
// 		auto initial_suspend (char const* called_from_function = __builtin_FUNCTION (), int called_from_line = __builtin_LINE ()) noexcept -> suspend_always {
...
// 				return false;
// 			}
// 			auto await_suspend (coroutine_handle <promise_type> handle, char const* called_from_function = __builtin_FUNCTION (), int called_from_line = __builtin_LINE ()) noexcept -> coroutine_handle <> {
...
// 			return false;
// 		}
// 		auto await_suspend (coroutine_handle <> continuation, char const* called_from_function = __builtin_FUNCTION (), int called_from_line = __builtin_LINE ()) noexcept -> coroutine_handle <> {
// 			std::cout << "\"" << __LINE__ << " coro::awaiter::await_suspend (coroutine_handle <> continuation)\" called from << \"" << called_from_line << " " << called_from_function << "\"" << std::endl;
...
// 		}
// 		explicit awaiter (coroutine_handle <promise_type> handle, char const* called_from_function = __builtin_FUNCTION (), int called_from_line = __builtin_LINE ()) noexcept : handle {handle} {
// 			std::cout << "\"" << __LINE__ << " coro::awaiter::awaiter (coroutine_handle <promise_type> handle)\" called from << \"" << called_from_line << " " << called_from_function << "\"" << std::endl;				
// 		}
// 		private:
...
// private:
// 	explicit coro (coroutine_handle <promise_type> handle, char const* called_from_function = __builtin_FUNCTION (), int called_from_line = __builtin_LINE ()) noexcept : handle {handle} {
// 		std::cout << "\"" << __LINE__ << " coro::coro (coroutine_handle <promise_type> handle)\" called from << \"" << called_from_line << " " << called_from_function << "\"" << std::endl;
// 	}
